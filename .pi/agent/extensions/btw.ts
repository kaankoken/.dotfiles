// ponytail: vendored mitsupi /btw. 1.6.0 calls Agent.replaceMessages (removed in pi 0.84).
// Drop this file + restore package "extensions/btw.ts" when mitsupi publishes the state.messages fix.
import {
	buildSessionContext,
	createAgentSession,
